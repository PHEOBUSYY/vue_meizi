<template>
  <f7-page>
    <f7-navbar title="Form" back-link="Back" sliding theme="yellow" layout="dark"></f7-navbar>
    ...
    <f7-list form>
      <f7-list-item :key="n" v-for="n in 3" checkbox name="my-checkbox" :value="n" :title="'Checkbox ' + n"></f7-list-item>
    </f7-list>

    <f7-block-title>Radios</f7-block-title>
    <f7-list form>
      <f7-list-item :key="n" v-for="n in 3" radio name="my-radio" :checked="n === 1" :value="n" :title="'Radio ' + n"></f7-list-item>
    </f7-list>
